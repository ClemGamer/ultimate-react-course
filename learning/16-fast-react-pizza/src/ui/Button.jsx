...
function Button({ children, disabled, to, type }) {
  const base =
    "inline-block rounded-xl text-sm bg-yellow-400 uppercase tracking-wide text-stone-800 transition-colors hover:bg-yellow-300 focus:bg-yellow-300 focus:outline-none focus:ring focus:ring-yellow-300 focus:ring-offset-2 disabled:cursor-not-allowed font-semibold";
